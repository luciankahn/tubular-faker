module TubularFaker
  ...
  GENERAL = {
    adjectives: ["Absolute", "Awesome", "Bogus", "Bomb", "Booyah", "Bummer", "Busted", "Chillin'", "Cowabunga", "Creepy", "Cyber", "Dope", "Exactamundo", "Extreme", "Far Out", "Fly", "Gnarly", "Grunge", "Hasta la Vista", "Hella", "Kewl", "Mega", "Mondo", "Nuclear", "Phat", "Rad", "Radical", "Rockin' Rappin'", "Shady", "Spooky", "Tight", "Total", "Tubular", "Tubuloso", "Whatever", "Wicked", "Wild and Crazy", "l33t"],
  ...
  COMPANIES = {
    products: ["3D", "Applets", "Arcade", "BBS", "Babies", "Beanies", "Beans", "Beepers", "Body Splash", "Boots", "Cards", "Cereal", "Dot-Com", "Dudes", "Dudettes", "Flannel", "Frames", "Headphones", "Hot Links", "IIGS", "Jewels", "Juice", "Net", "Netiquette", "Pogs", "Screensavers", "Scrunchies", "Shimmer", "Snax", "Sneakers", "Soakers", "Soda", "Stickers", "Superhighway", "Tapes", "Trolls", "Virtual Reality"]
  }
  ...
  def self.email
    "#{NAMES[:first_names].sample.gsub(/[eio\s]/, {'e' => '3', 'i' => '1', 'o' => '0', ' ' => '_'})}#{GENERAL[:numbers].sample}@#{INTERNET[:domains].sample}#{INTERNET[:dot].sample}"
  end
